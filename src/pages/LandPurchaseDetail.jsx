...
export const LandPurchaseDetail = () => {
  ...
  const fetchPurchaseDetails = async () => {
    try {
      ...
      const res = await axios.get(
        `http://72.61.169.226/admin/purchase/land/details/${landId}`,
        {
  ...
  const fetchLandDetails = async () => {
    try {
      const res = await axios.get(`http://72.61.169.226/admin/land/${landId}`, {
        headers: { Authorization: `Bearer ${token}` },
      });
        ...
        <div className="flex items-center gap-3">
          ...
          <div>
            ...
            <p className="text-sm text-gray-600">
              Land ID: <span className="font-mono">{landId}</span>
            </p>
          </div>
        </div>
      </header>
              ...
              <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
                <div className="space-y-2">
                  ...
                  <p className="text-gray-800">
                    {landDetails.land_location?.village || "N/A"}, 
                    {landDetails.land_location?.mandal || "N/A"}, 
                    {landDetails.land_location?.district || "N/A"}
                  </p>
                </div>
                ...
                <div className="space-y-2">
                  ...
                  <p className="text-gray-800">
                    {landDetails.land_details?.land_area || "N/A"} Acres • 
                    ₹{landDetails.land_details?.price_per_acre?.toLocaleString() || "N/A"}/Acre
                  </p>
                </div>
                ...
                <div className="space-y-2">
                  ...
                  <p className="text-2xl font-bold text-gray-800">
                    ₹{landDetails.land_details?.total_land_price?.toLocaleString() || "N/A"}
                  </p>
                </div>
              </div>
            </div>
              ...
              <div className="flex items-center justify-between">
                <div>
                  ...
                  <p className="text-2xl font-bold text-green-600">
                    {purchaseData.filter(p => p.status?.toLowerCase() === 'approved').length}
                  </p>
                </div>
