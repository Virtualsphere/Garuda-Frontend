...
export const UpdatePhysicalVerificationModal = ({ row, onClose, onSuccess}) => {
  ...
  const handleSubmit = async () => {
    ...
    try {
      ...
      const updateData = { 
        ...
        updateData.physical_verification_amount = parseFloat(amount);

      const endpoint = `http://72.61.169.226/admin/physical/wallet/${row.id || row.physical_verification_id}`;
      ...
      toast.success(`Physical Verification Wallet updated successfully!`);
      onSuccess();
      setTimeout(() => {
        onClose();
      }, 1000);
              ...
              <div className="flex items-center">
                ...
                <div>
                  <h3 className="text-xl font-bold text-gray-800">
                    Update Physical Verification Wallet
                  </h3>
                  <p className="text-sm text-gray-600 mt-1">
                    {"Physical Verification Amount"} Amount for {row.name}
                  </p>
                </div>
              </div>
              <button
              ...
              <div className="space-y-2">
                ...
                <div className="relative">
                  ...
                  <input
                    ...
                    placeholder={"Enter Physical Verification amount"}
                    min="0"
                    step="1"
                  />
                ...
                <p className="text-xs text-gray-500">
                  {"This amount will be sent as physical verification amount field"}
                </p>
              </div>
          ...
          <div className="px-6 py-4 border-t border-gray-100 flex-shrink-0 bg-gray-50 rounded-b-2xl">
            <div className="flex flex-col space-y-3">
              <div className="text-xs text-gray-500 text-center">
                Updating: <span className="font-mono font-medium">physical verification amount field</span>
              </div>
